...
MERGE (c2:Claim {claim_id: 'claim_actium_in_republic_31bce_001'})
SET c2.cipher = 'b2a2c3d4e5f60718293a4b5c6d7e8f90112233445566778899aabbccddeeff01',
    ...
    c2.source_agent = 'agent_roman_republic_v1',
...
MATCH (e:Event {entity_id: 'evt_battle_of_actium_q193304'})
MATCH (p:Period {entity_id: 'prd_roman_republic_q17167'})
MATCH (c2:Claim {claim_id: 'claim_actium_in_republic_31bce_001'})
...
MERGE (rc2:RetrievalContext {retrieval_id: 'retr_actium_q193304_001'})
SET rc2.agent_id = 'agent_roman_republic_v1',
    rc2.timestamp = toString(datetime()),
    rc2.source = 'wikidata',
    rc2.seed_qid = 'Q193304';

MATCH (c2:Claim {claim_id: 'claim_actium_in_republic_31bce_001'})
MATCH (rc2:RetrievalContext {retrieval_id: 'retr_actium_q193304_001'})
MERGE (c2)-[:USED_CONTEXT]->(rc2);

MERGE (run2:AnalysisRun {run_id: 'run_actium_001'})
SET run2.pipeline_version = 'v1.0',
    run2.status = 'completed',
    run2.created_at = toString(datetime());

MATCH (c2:Claim {claim_id: 'claim_actium_in_republic_31bce_001'})
MATCH (run2:AnalysisRun {run_id: 'run_actium_001'})
MERGE (c2)-[:HAS_ANALYSIS_RUN]->(run2);

MERGE (f2:Facet {facet_id: 'facet_military', label: 'Military'});

MERGE (fa2:FacetAssessment {assessment_id: 'fa_actium_mil_001'})
SET fa2.score = 0.93,
...
MATCH (run2:AnalysisRun {run_id: 'run_actium_001'})
MATCH (fa2:FacetAssessment {assessment_id: 'fa_actium_mil_001'})
