...
OPTIONAL MATCH (e)-[:SUBJECT_OF]->(c2:Claim {claim_id: 'claim_q193304_occurred_during_q17167_neg0031_09_02'})
OPTIONAL MATCH (p)-[:SUBJECT_OF]->(c2)
OPTIONAL MATCH (c2)-[:USED_CONTEXT]->(rc2:RetrievalContext {retrieval_id: 'retr_q193304_wikidata_occurred_during_q17167'})
OPTIONAL MATCH (c2)-[:HAS_ANALYSIS_RUN]->(run2:AnalysisRun {run_id: 'run_q193304_occurred_during_q17167'})
OPTIONAL MATCH (run2)-[:HAS_FACET_ASSESSMENT]->(fa2:FacetAssessment {assessment_id: 'fa_q193304_military_occurred_during_q17167'})
