...
| fuzzy_threshold (name match) | ~285 | 0.80 | Architect | new — D14 DETERMINE entity resolution acceptance |
...
| Value | Scripts | Risk |
|-------|---------|------|
| FORBIDDEN_FACETS | subject_concept_facet_agents.py, sca_agent.py | HIGH — two places, one truth |
