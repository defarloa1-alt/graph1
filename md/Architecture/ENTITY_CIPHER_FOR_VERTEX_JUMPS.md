...
| PERIOD | `prd` | `ent_prd_Q17167` (Roman Republic as period) |
| MATERIAL | `mat` | `ent_mat_Q753` (Copper) |
| OBJECT | `obj` | `ent_obj_Q34379` (Sword) |

**Rules:**
- Prefix is **always 3 characters**, lowercase
- Entity type is determined by the SCA during classification (see §7)
- New entity types require a registry update (locked list, like facets)
