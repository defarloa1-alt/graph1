...
### `embeddings`
- `scripts/ml/link_prediction_gnn.py` | type=`script` | scope=`read_only` | gates=`none`
- `scripts/ml/train_kg_embeddings.py` | type=`script` | scope=`read_only` | gates=`none`
- `md/Architecture/EMBEDDING_ASSISTED_DISAMBIGUATION_POLICY_2026-02-18.md` | type=`architecture_doc` | scope=`read_only` | gates=`none`
- `md/Architecture/EMBEDDING_BASELINE_SCOPE_2026-02-18.md` | type=`architecture_doc` | scope=`read_only` | gates=`none`
- `md/Architecture/EMBEDDING_VECTOR_INDEX_INTEGRATION_PLAN_2026-02-18.md` | type=`architecture_doc` | scope=`read_only` | gates=`none`
...
### `gnn`
- `scripts/ml/link_prediction_gnn.py` | type=`script` | scope=`read_only` | gates=`none`
- `md/Architecture/GNN_EXPERIMENT_PROTOCOL_2026-02-18.md` | type=`architecture_doc` | scope=`read_only` | gates=`none`
