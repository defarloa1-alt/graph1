...
**Canonical Set (18 agents):**
1. **SFA-ARCHAEOLOGICAL**: Material culture, excavations, artifact analysis
2. **SFA-ARTISTIC**: Visual arts, architecture, aesthetics
3. **SFA-BIOGRAPHIC**: Personal history, biography, life events, prosopography
4. **SFA-COMMUNICATION**: Media, rhetoric, propaganda, ceremonies, oral traditions
5. **SFA-CULTURAL**: Customs, traditions, cultural practices
6. **SFA-DEMOGRAPHIC**: Population, migration, census data
7. **SFA-DIPLOMATIC**: Treaties, embassies, international relations
8. **SFA-ECONOMIC**: Trade, currency, fiscal policy, resources
9. **SFA-ENVIRONMENTAL**: Climate, geography, natural resources
10. **SFA-GEOGRAPHIC**: Places, spatial relationships, territorial control
11. **SFA-INTELLECTUAL**: Philosophy, literature, education
12. **SFA-LINGUISTIC**: Languages, scripts, translation
13. **SFA-MILITARY**: Battles, commands, strategy, fortifications
14. **SFA-POLITICAL**: Governance, institutions, law, authority
15. **SFA-RELIGIOUS**: Cult, ritual, priesthood, temples
16. **SFA-SCIENTIFIC**: Technology, medicine, mathematics
17. **SFA-SOCIAL**: Class, family, gender, social structure
18. **SFA-TECHNOLOGICAL**: Engineering, innovation, tools
